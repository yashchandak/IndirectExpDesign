...
from datasets.data_CIV import Toy_data
...
class Parser(object):
    def __init__(self):
        ...
        parser.add_argument("--debug", default=2, type=int, help="Debug modes: {0, 1, 2}")
    ...
    def Experiment_setup_args(self, parser):
        ...
        parser.add_argument("--conf_strength", default=0.5, help="Strength of confounder", type=float)
    ...
    def Main_args(self, parser):
        ...
        parser.add_argument("--boot_sample_size", default=20, help="Number of bootstrap dataset replicas", type=int)
